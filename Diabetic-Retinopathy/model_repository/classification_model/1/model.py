...
MODEL_CONFIG_NAME = 'eyepacs/multiclass_model'
class ARGS:
...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        # model_version = client.get_model(os.getenv("INFERENCE_MODEL_FQN")) # e.g. "model:truefoundry/user/iris-demo/iris-classifier:1"
        # self.model = model_version.load(map_location=torch.device('cpu'))
        
        # Define the relative path to your model file
        model_relative_path = "/model_repository/classification_model/1/model.pth"
